...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'core.flag': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 16, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
